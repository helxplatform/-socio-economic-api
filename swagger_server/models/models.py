...
class CensusBlockGrps2021(Base):
    __tablename__ = 'census_block_grps_2021'

    gid = Column(Integer, primary_key=True, server_default=text("nextval('census_block_grps_2021_gid_seq'::regclass)"))
    statefp = Column(String(2))
    countyfp = Column(String(3))
    tractce = Column(String(6))
    blkgrpce = Column(String(1))
...
class SocioEconomicData2019(Base, SerializerMixin):
    ...
    bgid2021 = Column(Text, unique=True)
    ...
    estpopulation_2021 = Column(BigInteger)
    ...
    estresidentialdensity_2021 = Column(Float(53))
    ...
    estmedianhouseholdincome_2021 = Column(MONEY)
    ...
    estpropnonhispwhite_2021 = Column(Float(53))
    estprophouseholdnonhispwhite_2021 = Column(Float(53))
    ...
    estpropfemalehouseholdnospouse_2021 = Column(Float(53))
    ...
    estpropfemalehouseholdfamilychild_2021 = Column(Float(53))
